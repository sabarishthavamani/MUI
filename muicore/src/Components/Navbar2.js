...
import SignupDialog from './Admin/AdminSignUp';
import LoginDialog from './Admin/Login';
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <div sx={{ ml: 'left' }}>
            {/* Align the following buttons to the right */}
            <Button color="inherit" onClick={handleOpenSignupDialog}>
              Signup
            </Button>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {['AdminData', 'Login', 'Send email', 'Drafts'].map((text, index) => (
